...
if TYPE_CHECKING:
    ...
    from app.models.job_position import ResumeJobMatch
...
class Resume(Base):
    ...
    raw_text: Mapped[str | None] = mapped_column(
        Text(length=16777215), default=None
    )  # MEDIUMTEXT
    ...
    job_matches: Mapped[list["ResumeJobMatch"]] = relationship(
        "ResumeJobMatch", back_populates="resume", cascade="all, delete-orphan"
    )
