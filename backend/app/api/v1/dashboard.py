...
async def get_dashboard(
    ...
    states = await load_effective_interview_states(get_graph_runtime(), list(recent))
    ...
    return {
        ...
        "data": {
            ...
            "recent_interviews": [_interview_dict(s, states[s.id]) for s in recent],
        }
    }
...
def _interview_dict(s: InterviewSession, state: dict | None) -> dict:
